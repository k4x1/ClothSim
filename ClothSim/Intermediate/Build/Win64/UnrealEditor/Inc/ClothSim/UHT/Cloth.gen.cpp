...
struct Z_Construct_UClass_ACloth_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_SphereActor_MetaData[] = {
		{ "Category", "Collision" },
		{ "ModuleRelativePath", "Public/Cloth.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_CapsuleActor_MetaData[] = {
		{ "Category", "Collision" },
		{ "ModuleRelativePath", "Public/Cloth.h" },
	};
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_SphereActor;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_CapsuleActor;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ACloth_Statics::NewProp_SphereActor = { "SphereActor", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACloth, SphereActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SphereActor_MetaData), NewProp_SphereActor_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ACloth_Statics::NewProp_CapsuleActor = { "CapsuleActor", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACloth, CapsuleActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CapsuleActor_MetaData), NewProp_CapsuleActor_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ACloth_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ACloth_Statics::NewProp_SphereActor,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ACloth_Statics::NewProp_CapsuleActor,
...
struct Z_CompiledInDeferFile_FID_forkRepos_ClothSim_ClothSim_Source_ClothSim_Public_Cloth_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACloth, ACloth::StaticClass, TEXT("ACloth"), &Z_Registration_Info_UClass_ACloth, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACloth), 3449192848U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_forkRepos_ClothSim_ClothSim_Source_ClothSim_Public_Cloth_h_3025678152(TEXT("/Script/ClothSim"),
